...
void Util::PipelineLayout::SetRange(uint32_t index, Descriptor::Type type, uint32_t num, uint32_t baseReg, uint32_t space)
{
...
{
	D3D12_DESCRIPTOR_RANGE_TYPE rangeTypes[Descriptor::NUM];
	rangeTypes[Descriptor::SRV] = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	rangeTypes[Descriptor::UAV] = D3D12_DESCRIPTOR_RANGE_TYPE_UAV;
	rangeTypes[Descriptor::CBV] = D3D12_DESCRIPTOR_RANGE_TYPE_CBV;
	rangeTypes[Descriptor::SAMPLER] = D3D12_DESCRIPTOR_RANGE_TYPE_SAMPLER;
